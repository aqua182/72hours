...
apply_migration_if_missing "Patient insight receipt migration" "SELECT to_regprocedure('get_my_patient_insights()') IS NOT NULL" pilot-runtime/db/migrations/0009_patient-insight-receipts.sql
