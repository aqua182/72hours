...
export default function PilotWorkspace() {
  ...
  async function submitPatientInsight() {
    ...
    try { await responseJson("/api/patient-insights", { method: "POST", headers: { "content-type": "application/json" }, body: JSON.stringify({ patientId: patientSummaries[0].patientId, content: patientInsight }) }); setPatientInsight(""); setMessage("Your insight was shared with the care team. It is not published back to the patient view."); } catch { setMessage("The patient insight could not be submitted."); }
  }
